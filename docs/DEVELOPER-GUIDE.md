...
How the site is built, how to edit its content, and how to deploy it.
For what the site is, start with the [README](../README.md).
...
app/
  ...
  page.tsx            the whole site on one page, every section in order
  not-found.tsx       the 404 page
  api/contact/        validation, rate limiting, Resend delivery
  sitemap.ts          generated from lib/site.ts
  robots.ts
components/sections/  Hero, Contributions, Projects, Experience, Tools, Blog, Contact
components/
